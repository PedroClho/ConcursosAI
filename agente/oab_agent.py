...
from agente.tools import SearchTools
...
- buscar_questoes: busca questões de prática de uma matéria específica
- explicar_questao: explica uma questão mostrando gabarito e artigos relacionados

Quando o usuário pedir questões para praticar:
1. Use buscar_questoes especificando a matéria
2. Se ele quiser explicação/gabarito de uma questão específica, use explicar_questao
